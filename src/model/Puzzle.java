...
/**
 * Represents a puzzle in the adventure game world.
 * A puzzle blocks the player's progress until it is solved,
 * either by providing a text answer or using the correct item.
 *
 * <p>Solution format:
 * <ul>
 *   <li>If the solution is wrapped in single quotes (e.g. {@code 'Align'}),
 *       the player must type a text answer using the Answer command.</li>
 *   <li>Otherwise, the solution is an item name and the player must
 *       use that item with the Use command.</li>
 * </ul>
 */
public class Puzzle {
    ...
    /**
     * Returns whether this puzzle is currently active.
     * An active puzzle blocks the room and overrides its description.
     *
    ...
    /**
     * Returns the raw solution string as stored in the game data.
     * Use {@link #getCleanSolution()} to get the solution without single quotes.
     *
    ...
    /**
     * Returns the effects text shown when this puzzle is active in a room.
     * This text replaces the room's normal description while the puzzle is active.
     *
    ...
    /**
     * Returns whether this puzzle requires a text answer rather than an item.
     * A puzzle requires a text answer if its solution is wrapped in single quotes.
     * For example, {@code 'Align'} is a text answer, while {@code Ticket} is an item.
     *
    ...
    /**
     * Returns the solution string with surrounding single quotes removed.
     * If the solution is not a text answer, returns the raw solution unchanged.
     *
    ...
    /**
     * Deactivates this puzzle, marking it as solved.
     * Once deactivated, the puzzle no longer blocks the room or affects the player.
     */
    ...
    /**
     * Checks whether the given text answer solves this puzzle.
     * Comparison is case-insensitive.
     * For item-based puzzles, use {@link #solveWithItem(String)} instead.
     *
    ...
    /**
     * Checks whether the given item name solves this puzzle.
     * Only applies to item-based puzzles (solution without single quotes).
     * Comparison is case-insensitive.
     *
