...
/**
 * Represents a monster in the adventure game world.
 * A monster blocks the player's progress and may attack the player
 * when they attempt to move. The monster is defeated by using the
 * correct item against it.
 */
public class Monster {
    ...
    /**
     * Returns whether this monster is currently active.
     * An active monster blocks the room and overrides its description.
     *
    ...
    /**
     * Returns the effects text shown when this monster is active in a room.
     * This text replaces the room's normal description while the monster is active.
     *
    ...
    /**
     * Returns the damage this monster inflicts per attack.
     * The value is negative (e.g. -15), and should be applied using
     * {@code Math.abs(getDamage())} when calling {@code Player.takeDamage()}.
     *
    ...
    /**
     * Returns whether this monster actively attacks the player on movement.
     * If true, the monster attacks whenever the player attempts to move
    ...
    /**
     * Deactivates this monster, marking it as defeated.
     * Once deactivated, the monster no longer blocks the room or attacks the player.
     */
